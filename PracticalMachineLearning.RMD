...
For this assignment I analysed the provided data to determine what activity an individual perform.
...
The data  had few values "#DIV/0!" that were replaced by  "NA ".
...
As can be seen from the confusion matrix this model is very accurate. Because my test data was around 99% 
